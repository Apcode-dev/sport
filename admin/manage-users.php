                            ...
                            if($count>0)
                            {
                                ...
                                while($rows=mysqli_fetch_assoc($res))
                                {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="update-users.php?id=<?php echo $id; ?>" ><img src="../images/icons/update-user.png"/></a>
                                        </td>
                                            <td>
                                            <a href="delete-users.php?id=<?php echo $id; ?>" ><img src="../images/icons/delete-user.png"/></a>
