...
if (isset($_GET['item_id'])) {
    ...
    $sql = "SELECT * FROM tbl_sport WHERE id=$item_id";
    //Execute the Query
...
<section class="item-order">
    <div class="container">
        <h2 class="text-center text-black">Please confirm to place order</h2>

        <form action="" method="POST" class="order">
            <fieldset>
                <legend style="color:black;">Selected item</legend>
                ...
                <div class="item-menu-desc">
                    ...
                    <p class="item-price" style="color:black;">₹<?php echo $price; ?></p>
        ...
        if (isset($_POST['submit'])) {
            if (empty($_SESSION["u_id"])) {
                ...
                if ($res2 == true) {
                    ...
                    $_SESSION['order'] = "<div class='error text-center'>Failed to Order item.</div>";
